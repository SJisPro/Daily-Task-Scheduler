...
import { CheckIcon, PencilSquareIcon, TrashIcon, ClockIcon, CalendarDaysIcon, ExclamationCircleIcon } from '@heroicons/react/24/outline';
    ...
    >
      ...
      <div className="flex items-start justify-between p-4 pl-5">
        ...
        <div className="flex gap-1 ml-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          >
            <PencilSquareIcon className="w-4.5 h-4.5 w-[18px] h-[18px]" />
          </button>
          <button
